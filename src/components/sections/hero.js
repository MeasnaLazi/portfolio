...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Sovannmeasna Ly.</h2>;
  const three = <h3 className="big-heading">Writing code is not fun,<br/>Solving problem by code is.</h3>;
  const four = (
    <>
      <p>
      I am a software engineer. I love delivering remarkable software solutions.
